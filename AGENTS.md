...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/yazelix-archbp-1b1db7ac/context` | Codebase overview, check index freshness |
| `gitnexus://repo/yazelix-archbp-1b1db7ac/clusters` | All functional areas |
| `gitnexus://repo/yazelix-archbp-1b1db7ac/processes` | All execution flows |
| `gitnexus://repo/yazelix-archbp-1b1db7ac/process/{name}` | Step-by-step execution trace |
